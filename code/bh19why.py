...
Clock.bpm=20 
b2 >> marimba(P*[P*[0,2,4]+P(1,3,4,7)]+P[1,2,6].amen(=).stretch(me
...
t3 >> bass(P[0,[1,3],[3,4]].arp([1,2,4,6,8]),dur=P[2,1,1],lpf=120,amp=.5,sus=[1,2,1] )

t8 >> donk(p1.pitch, dur=8, sus=4, room=1, oct=5, amp=0.9) + [0,0,0,P*(2,4,3,-1)]
