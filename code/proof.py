...
q2 >> play("(*-(Vx X ))", sample=P[0:9],amp=[10,0,10], echo=1)
q3 >> bass(P[-12:-8], dur=rest(2)|P[1:3], amp=1)


q7 >> ripple([-12,0,-8], dur=PDur(7,31)|rest(2))

q8 >> blip(P[-12,-13].stutter(8))

Scale.default.set("dorian", tuning=TuPning.just)
